              ...
              <v-card width="auto" dark rounded="xl">
                <v-card dark width="auto" height="auto">
                  <v-row class="text-center ma-3" justify="space-around">
                    ...
                    >
                    <div v-show="lottoaom">
                      <v-icon>unfold_more</v-icon> <tabbottontsk />
                      <playbettks />
                    </div>
                  </v-row>
                </v-card>
...
export default {
  ...
  components: {
    ...
    tabbottontsk: require("@/components/lottostockmaray/tabbottonbank.vue")
      .default,
    playbettks: require("@/components/lottostockmaray/playbetdown.vue").default,
  },
  methods: {
    reloadPage() {
