...
export default {
  ...
  components: {
    Ratlottothai,
    subtext: require("@/views/dashbordstockmaray/subtext.vue").default,
    tabbottontks: require("@/components/lottostockmaray/tabbottonbank.vue")
      .default,
    playbettks: require("@/components/lottostockmaray/playbettode.vue").default,
  },
  methods: {
    reloadPage() {
