      ...
      <div class="container">
        <div class="container">
          ...
          <v-btn
            ...
            small
            width="150"
            @click.prevent="$store.state.subtext = !$store.state.subtext"
            >วิธีเล่น</v-btn
          >
          <div v-show="$store.state.subtext"><subtext /></div>
          <div class="row">
            <div class="col-md-6">
              <v-card width="auto" dark rounded="xl">
                <v-card dark width="auto" height="auto">
                  <v-row class="text-center ma-3" justify="space-around">
                    ...
                    >
                    <div v-show="lottoaom">
                      <v-icon>unfold_more</v-icon> <tabbottontks />
                      <playbettk />
                    </div>
                  </v-row>
                </v-card>
...
export default {
  ...
  components: {
    Ratlottothai,
    subtext: require("@/views/dashbordstockdowjoe/subtext.vue").default,
    tabbottontks: require("@/components/lottostockdowjoe/tabbottonstock.vue")
      .default,
    playbettk: require("@/components/lottostockdowjoe/playbetdown.vue").default,
  },
  methods: {
    reloadPage() {
