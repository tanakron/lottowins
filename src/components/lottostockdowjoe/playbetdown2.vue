  ...
  >
    ...
    <v-form @submit.prevent="onSubmit()">
      <v-otp-input
        ...
        width="30"
        class="ma-3 pa-2"
        v-model="addplay.bet2down"
        @click:append="this.addplay.bet2down"
        @keyup.enter="this.addplay.bet2down"
      ></v-otp-input>
      <v-text-field
        clearable
        name="betpay"
...
export default {
  ...
  methods: {
    async onSubmit() {
      ...
      await axios.post(
        "http://localhost:3000/postplaylotto/stockplaylottodown",
        this.addplay
      );
